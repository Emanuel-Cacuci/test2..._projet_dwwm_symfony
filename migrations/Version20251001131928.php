 ...
 */
final class Version20251001131928 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, auteur_id INT NOT NULL, nom VARCHAR(100) NOT NULL, prix NUMERIC(4, 2) NOT NULL, images VARCHAR(255) NOT NULL, stock INT NOT NULL, slug VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_29A5EC27BCF5E72D (categorie_id), INDEX IDX_29A5EC2760BB6FE6 (auteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
